...
const double RampTime = 0.425;//0.375;
const double ClosedLoopRampTime = 0.1;
const double RightP = 0.0678;
const double RightI = 6.78E-6; // 0.001;
const double RightD = 0;
const double RightF = 0.050468;
const double LeftP = 0.073814156 ;
const double LeftI = 7.3814156E-6; // 0.001;
const double LeftD = 0;
const double LeftF = 0.050468;
